...
export const heroDemo = {
  ...
  before: {
    ...
    text:
      ...
      "나. 판매경로 등 (1) 국내 (2) 해외 (3) 판매경로별 매출액 비중 다. 판매방법 및 조건 (1) 국내 (2) 해외 " +
      "라. 판매전략 ㆍ프리미엄 제품을 중심으로 한 시장 우위 강화 ㆍ브랜드, 제품, 서비스를 통해 고객에게 차별화된 가치 제공 " +
      "ㆍ고객ㆍ시장 중심의 수요 촉발 마케팅 강화 마. 주요 매출처 2026년 1분기 당사의 주요 매출처로는 Alphabet, Amazon, " +
      "Apple, Hong Kong Techtronics, Supreme Electronics 등(알파벳순) 입니다. 당사의 주요 5대 매출처에 대한 매출비중은 " +
      "전체 매출액 대비 약 23% 수준입니다. 바. 수주상황",
  },
  finding: {
    severity: "high",
