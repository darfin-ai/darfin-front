...
/* Badge recipe per DESIGN_SYSTEM.md §5.4 — rounded-full, bordered, palette colors only. */
const TYPE_BADGE = {
...
export function RecentFilingsPanel({ filings }) {
  ...
  return (
    <div className="flex flex-col rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4">
      <h2 className="mb-3 text-sm font-medium text-slate-900 dark:text-slate-100">최근 보고서</h2>
